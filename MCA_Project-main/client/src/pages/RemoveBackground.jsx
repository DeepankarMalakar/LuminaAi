      ...
      <div className="flex items-start flex-wrap gap-6">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-[#EC4899] to-[#F59E0B] flex items-center justify-center">
              <Sparkles className="w-5 h-5 text-white" />
            </div>
            <h2 className="text-xl font-semibold text-text-primary">Upload Image</h2>
          </div>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#EC4899] to-[#F59E0B] text-text-primary px-4 py-3 mt-6 text-sm font-medium rounded-lg cursor-pointer transition-all duration-300 hover:shadow-lg hover:shadow-pink-500/50 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-[#F59E0B] to-[#EC4899] flex items-center justify-center">
            ...
            {!content ? (
              ...
              >
                <div className="text-center flex flex-col items-center gap-5">
                  ...
                  >
                    <Eraser className="w-12 h-12 text-text-secondary" />
                  </motion.div>
                  <p className="text-text-secondary text-sm">
                    Upload an image and click "Remove Background" to process
                  </p>
                </div>
              </motion.div>
            ) : (
